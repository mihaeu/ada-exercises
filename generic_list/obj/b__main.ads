...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#3e14573e#;
   ...
   u00136 : constant Version_32 := 16#21a371f4#;
   pragma Export (C, u00136, "personB");
   u00137 : constant Version_32 := 16#a6d8eb59#;
   pragma Export (C, u00137, "personS");
   u00138 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00138, "system__concat_6B");
   u00139 : constant Version_32 := 16#cfe06933#;
   pragma Export (C, u00139, "system__concat_6S");
   u00140 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00140, "system__concat_5B");
   u00141 : constant Version_32 := 16#9a7907af#;
   pragma Export (C, u00141, "system__concat_5S");
   u00142 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00142, "system__concat_4B");
   u00143 : constant Version_32 := 16#63436fa1#;
   pragma Export (C, u00143, "system__concat_4S");
   u00144 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00144, "system__concat_3B");
   u00145 : constant Version_32 := 16#16571824#;
   pragma Export (C, u00145, "system__concat_3S");
   u00146 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00146, "system__concat_2B");
   u00147 : constant Version_32 := 16#1f879351#;
   pragma Export (C, u00147, "system__concat_2S");
   u00148 : constant Version_32 := 16#2fe44a4d#;
   pragma Export (C, u00148, "person_linked_listB");
   u00149 : constant Version_32 := 16#a8029a5e#;
   pragma Export (C, u00149, "person_linked_listS");
   u00150 : constant Version_32 := 16#5e704f5f#;
   pragma Export (C, u00150, "linked_listB");
   u00151 : constant Version_32 := 16#f1420f24#;
   pragma Export (C, u00151, "linked_listS");
   u00152 : constant Version_32 := 16#e34550ca#;
   pragma Export (C, u00152, "system__pool_globalB");
   u00153 : constant Version_32 := 16#c88d2d16#;
   pragma Export (C, u00153, "system__pool_globalS");
   u00154 : constant Version_32 := 16#9d39c675#;
   pragma Export (C, u00154, "system__memoryB");
   u00155 : constant Version_32 := 16#445a22b5#;
   ...
   --  person%s
   --  person%b
   --  person_linked_list%s
   --  person_linked_list%b
   --  main%b
